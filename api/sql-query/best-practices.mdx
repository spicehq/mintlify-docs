...
Best practices and tips for getting the most out of Spice
...
The [Apache Arrow API](/api/sql-query/apache-arrow-flight-api) uses Apache Arrow Flight to deliver results over a high-performance connection. There is no limit to the number of results you can pull through the Arrow API while the HTTP API is [limited to results of 500 rows](/reference/limitations).
