...
Spice Datasets and Views are defined in YAML. To create a Dataset or View, add a dataset YAML to the `.spice/datasets` path of the connected [GitHub repository](/portal/apps/connect-github-repository).
...
[`firecache`](/reference/specifications/dataset-and-view-yaml-specification/firecache)
