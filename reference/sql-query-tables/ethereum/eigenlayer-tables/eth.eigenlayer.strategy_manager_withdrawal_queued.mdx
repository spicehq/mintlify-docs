---
title: "eth.eigenlayer.strategy_manager_withdrawal_queued"
---
...
The party specified by `staker` who will be able to complete the queued withdrawal and receive the withdrawn funds.

`delegated_address`

CHARACTER VARYING

The party who the `staker` was delegated to at the time of creating the queued withdrawal.
