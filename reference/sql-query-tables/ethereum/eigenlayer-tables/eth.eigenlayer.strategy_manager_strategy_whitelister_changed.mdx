---
title: "eth.eigenlayer.strategy_manager_strategy_whitelister_changed"
---
...
The previous address of the strategy whitelister.

`new_address`

CHARACTER VARYING

The new address of the strategy whitelister.
