...
#### REGEXP\_MATCHES(*input* string, *regex* string) → boolean
...
This function is identical to the function [`REGEXP_LIKE`](/reference/sql-reference/all-functions/regular-expressions/regexp_like).
